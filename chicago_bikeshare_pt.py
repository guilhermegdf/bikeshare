...
def column_to_list(data, index):
    column_list = [itens[index] for itens in data]
...
all_gender = column_to_list(data_list, -2)
...
# ------------ NÃO MUDE NENHUM CÓDIGO AQUI ------------
assert answer != "As amostras com do tipo Customer não possuem sexo, com o numero total de linhas é maior que a soma do sexo masculino e femenino.", "TAREFA 8: Escreva sua própria resposta!"
# -----------------------------------------------------
...
trip_duration_list = sorted([ int(duration) for duration in column_to_list(data_list, 2)])
...
if len(trip_duration_list)%2 == 0:
    ...
    median_trip = trip_duration_list[int(index)]
...
if answer == "yes":
    ...
    print("Tipos:", types, "Counts:", sum(counts))
